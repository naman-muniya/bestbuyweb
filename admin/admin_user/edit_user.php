...
<div class="container">
  ...
  <?php
	...
	$select = "SELECT * FROM tbl_admin WHERE user_id='$edit_id'";
  ...
  <form action="" method="post" enctype="multipart/form-data">
	...
	<a class="btn btn-primary" href="index.php">View Admin</a>
    &nbsp;&nbsp;
  ...
  <?php
	...
	$update = "UPDATE tbl_admin SET user_name='$euser_name',user_email='$euser_email',user_password='$euser_password',user_image='$eimage',user_details='$euser_details' WHERE user_id='$edit_id' ";
