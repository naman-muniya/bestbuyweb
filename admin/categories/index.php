...
<body>
  <div class="wrapper">
    ...
    <div id="content">
      ...
      <div class="container">
        <h2> View Categories</h2><a class="btn btn-primary" href="add_category.php">Add Category</a>
        <br><br>
        <?php
        $conn =  mysqli_connect('localhost', 'root', '', 'db_bestbuy');
        if (isset($_GET['del'])) {
          $del_id =  $_GET['del'];
          $delete =  "DELETE FROM categories WHERE category_id='$del_id'";
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><a class="btn btn-danger" href="index.php?del=<?php echo $category_id; ?>">Delete</a></td>
                <td><a class="btn btn-success" href="edit_category.php?edit=<?php echo $category_id; ?>">Edit</a></td>
              </tr>
            <?php } ?>
