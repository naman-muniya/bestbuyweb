...
<body>
  <div class="wrapper">
    ...
    <div id="content">
              ...
              <li class="nav-item">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="../../admin_user/add_user.php">Admin</a></a>
      ...
      <div class="container">
        <h2>List of Locations</h2><a class="btn btn-primary" href="add_place.php">Add Location</a>
        <br><br>
        <?php
        $conn =  mysqli_connect('localhost', 'root', '', 'db_bestbuy');
        if (isset($_GET['del'])) {
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><a class="btn btn-success" href="edit_place.php?edit=<?php echo $place_id; ?>">Edit</a></td>
              </tr>
            <?php } ?>
