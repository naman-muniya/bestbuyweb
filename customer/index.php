               ...
               <div class="container-fluid">
                   ...
                   <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       <ul class="navbar-nav mr-auto">
                           ...
                           <li><a class="nav-link" href="about_us.php">About Us <span class="sr-only">(current)</span></a>
                        </li>
                       </ul>
       ...
       <div id="categ_cont">
           ...
           <div class="wrapper">
               ...
               <div class="container mt-5">
                   <div class="row">
                       <?php
                        $conn =  mysqli_connect('localhost', 'root', '', 'db_bestbuy');
                        $select = "SELECT * from tbl_product NATURAL JOIN tbl_discount";
                        $run_select = mysqli_query($conn, $select);
                        while ($row = mysqli_fetch_assoc($run_select)) {
          ...
          <div class='card' height='2000px' >
            ...
            <div class='card-body text-center'>
              ...
              <a class='btn btn-danger btn-sm btn-block' href='add_to_wishlist.php?id=$product_id'>Add to Wishlist</a>
